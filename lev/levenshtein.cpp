...
void addPAMSTEs(Automata *a, string pattern_id_s) {
	...
	string id_pam_0 = pattern_id_s + "_" + type + "_" + '0'; 
	string id_pam_1 = pattern_id_s + "_" + type + "_" + '1';
	string id_pam_2 = pattern_id_s + "_" + type + "_" + '2';
	...
	// Add the states to the Automata Network
	a->rawAddSTE(ste_0);
	a->rawAddSTE(ste_1);
	a->rawAddSTE(ste_2);
	
	// Connect the STEs
	a->addEdge(ste_0, ste_1);
	a->addEdge(ste_1, ste_2);
}
